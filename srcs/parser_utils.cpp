...
std::string ParserUtils::split(const std::string& input, const std::string& delimiter, int idx) {
...
std::string ParserUtils::strClean(const std::string& str, char c) {
    std::string result;
    char lastChar = '\0';
...
std::string& ParserUtils::ltrim(std::string& s) {
...
std::string& ParserUtils::rtrim(std::string& s) {
